...
const handleHashChange = () => {
    ...
    if (hash === '#laptops') {
        ...
        else if (hash === '#smartphones') {
        fetchAndRenderSmartphones();
    }
        else if(hash === '#computers'){
        fetchAndRenderComputer();
    }
        else if(hash === '#gadgets'){
        fetchAndRenderGadget();
    }
        else if(hash === '#tablets'){
        fetchAndRenderTablet();
    }
        else if(hash === '#about'){
